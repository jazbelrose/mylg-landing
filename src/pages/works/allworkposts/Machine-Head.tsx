...
const MachineHead = () => {
  ...
  const imageUrls = Array.isArray(machineHeadData) ? machineHeadData : [];
     ...
     <>
      ...
      <div className={`${opacityClass} ${isModalOpen ? 'no-scroll' : ''}`}>
        ...
        <div className="workpage-heading">
          <InlineSvg src="https://d2qb21tb4meex0.cloudfront.net/svg/machinehead.svg" onReady={() => setSvgReady(true)} />
        </div>
