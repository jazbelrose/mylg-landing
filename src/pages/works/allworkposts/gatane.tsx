...
import gataneData from './gatane.json';
...
const Gatane = () => {
  ...
  const imageUrls = Array.isArray(gataneData) ? gataneData : [];
  ...
  return (
    <>
     ...
     <Helmet>
                            ...
                            <title>Gatane 500 MG - *MYLG!*</title>
                          </Helmet>
      ...
      <div className={`${opacityClass} ${isModalOpen ? 'no-scroll' : ''}`}>
        ...
        <div className="workpage-heading">
          <InlineSVG src="https://d2qb21tb4meex0.cloudfront.net/svg/gatane/gataneheader.svg" onReady={() => setSvgReady(true)} />
        </div>
