...
const NikeFemme = () => {
  ...
  useEffect(() => {
    if (!isLoading && svgReady) {
      ...
      const galleryRefsCurrent = galleryRefs.current;
      ...
      galleryRefsCurrent.forEach((galleryItem) => {
    ...
    <>
      ...
      <div className={`${opacityClass} ${isModalOpen ? 'no-scroll' : ''}`}>
        ...
        <div className="workpage-heading">
          <InlineSVG src="https://d2qb21tb4meex0.cloudfront.net/svg/nikefemme.svg" onReady={() => setSvgReady(true)} />
        </div>
