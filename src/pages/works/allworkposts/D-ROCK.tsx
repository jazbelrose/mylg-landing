...
const DRock = () => {
  ...
  const imageUrls = Array.isArray(dRockData) ? dRockData : [];
    ...
    <>
      ...
      <div className={`${opacityClass} ${isModalOpen ? 'no-scroll' : ''}`}>
        ...
        <div className="workpage-heading">
          <InlineSVG src="https://d2qb21tb4meex0.cloudfront.net/svg/drock.svg" onReady={() => setSvgReady(true)} />
        </div>
              ...
              >
                <div className="img-wrapper">
                  <img
                    ...
                    onClick={() => openModal(i)} // Add this onClick handler
                  />
                </div>
              </div>
            ))}
